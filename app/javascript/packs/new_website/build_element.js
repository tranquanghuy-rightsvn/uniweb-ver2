  ...
  page.elements.map((ele, index) => {
    ...
    $('input.uni-detail-menu-seachable').change(function() {
      ...
      if(this.checked) {
        ...
        $('.' + parent + ' .uni-searchable').append('<form class="d-flex mb-0"><input class="form-control me-2" id="formSearchNav" type="search" placeholder="Search" aria-label="Search"><button class="btn btn-outline-success" onclick="search_nav()" type="button">Search</button></form>')
      } else {
