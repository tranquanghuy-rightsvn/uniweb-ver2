module RenderHtml
  class << self
    ...
    def render_signature website
      ...
      "<span id=\"data-website\" data-website=#{data_website} >"
    end
  end
end
